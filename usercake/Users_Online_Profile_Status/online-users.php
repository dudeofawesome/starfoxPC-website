...
<div id="wrapper">
	...
	<div id="content">
		...
		?>	
			...
			<p>
                <strong>Usuarios Totales</strong>: <?php echo $viewUsersOnlineView->ViewTotal(); ?>
				<strong>Usuarios Registrados</strong>: <?php echo $viewUsersOnlineView->ViewRegistred(); ?>
				<strong>Usuarios Visitantes</strong>: <?php echo $viewUsersOnlineView->ViewNoRegistred(); ?>
            </p>
		<?php
		} else {
		?>
